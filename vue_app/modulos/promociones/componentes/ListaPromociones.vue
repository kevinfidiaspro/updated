    ...
    <v-card class="pa-3 ma-3">
        ...
        >
            ...
            <template v-slot:item.action="{ item }">
                <router-link
                    ...
                    :to="{ path: `/guardar-promocion?id=${item.id}` }"
        ...
        <v-dialog v-model="dialog" max-width="500px">
            <v-card>
                <v-card-title
                    class="text-h5 aviso"
                    style="justify-content: center; background:#1d2735; color:white"
                >
                    Aviso
                </v-card-title>
...
export default {
    ...
    methods: {
        ...
        getAllpromociones() {
            axios.get("api/get-all-promociones").then(
                res => {
            ...
            axios
                .get(
                    `api/delete-promocion/${
                        this.promociones[this.selectedItem].id
                    }`
                )
                .then(
                    res => {
