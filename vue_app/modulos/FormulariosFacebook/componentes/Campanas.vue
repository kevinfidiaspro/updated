<template>
    <v-card class="pa-3 ma-3">
        <v-toolbar flat color="#1d2735" dark>
            ...
            <pre><v-toolbar-title><h2>Listado Campañas de Facebook</h2></v-toolbar-title></pre>
        </v-toolbar>
        ...
        >
            ...
            <template v-slot:item.action="{ item }">
                <router-link
                    ...
                    :to="{
                        path: `/guardar-formulario-facebook?id=${item.id}&page_id=${item.page_id}`,
                    }"
...
export default {
    ...
    methods: {
        getAllformularios() {
            axios
                .get(`webhook/get-all-formularios-activos?id=104140814678268`)
                .then(
                    (res) => {
